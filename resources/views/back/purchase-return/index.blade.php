    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Purchase Return</h3>
            </div>
                ...
                <div class="card-header border-0 bg-white">
                    <div class="row my-3">
                        ...
                        <div class="col-md-9 col-12 text-end">
                            ...
                            <a href="{{ route('manual-purchase-return.index') }}" class="btn rounded-3 mt-2 save-btn text-white"
                        ...
                        <tbody>
                            @foreach ($returns as $return)
                                <tr>
                                    ...
                                    {{-- <td class="text-primary align-middle">{{ $return->reference }}</td> --}}
                                    <td class="text-primary align-middle"><a class="text-decoration-none" href="{{route('purchase-return.detail', $return->id)}}">{{ $return->reference }}</a></td>
                                    <td class="align-middle">{{ $return->purchase->vendor->user->name ?? 'N/A' }}</td>
                                    <td class="align-middle">{{ $return->purchase->warehouse->users->name ?? 'N/A' }}</td>
                                    <td class="align-middle">
                                    ...
                                    <td class="align-middle green-border">
                                        <span
                                        ...
                                        <div>
                                            ...
                                            <div class="dropdown-menu p-2 ps-0" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item"
                                                    href="{{ route('purchase-return.detail', $return->id) }}">
                                                    <img src="{{ asset('back/assets/dasheets/img/menu.svg') }}"
                                                        class="img-fluid me-1" alt="" />
                                                    Return Detail
                                                </a>
                                                <a class="dropdown-item"
                                                    href="{{ route('purchase_return.edit', $return->id) }}">
                                                    <img src="{{ asset('back/assets/dasheets/img/menu.svg') }}"
                                                        class="img-fluid me-1" alt="" />
                                                    Edit Return
                                                </a>
                                                ...
                                                <form id="deleteForm"
                                                    action="{{ route('purchase_return.destroy', $return->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel"
            ...
            <div class="offcanvas-body">
                <form action="{{ route('purchase_returns.filter') }}" method="POST">
                    @csrf
                    @method('POST')
                    <div>
            ...
            $('#deleteRowTrigger').on("click", function(event){ // triggering delete one by one
                if(confirm("Are you sure you won't be able to revert this!")){
                    if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{route('purchase_return.delete')}}",
                            data: {ids},
