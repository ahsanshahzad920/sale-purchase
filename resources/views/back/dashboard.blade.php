...
@section('content')
    ...
    <div class="content">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-2 mt-4">
                <div class="mb-3">
                    <h2 class="mb-1 fw-bold">Welcome, {{auth()?->user()?->name}}</h2>
                    <p class="fw-medium heading">You have <span class="text-primary fw-bold" style="color: #E04F16 !important;">{{$totalTodayOrdersCount ?? '0'}}</span> Orders, Today</p>
                </div>
            ...
            <div class="alert alert-danger alert-dismissible fade show mb-4 border-0" style="background: #FCEFEA;">
                <div>
                    <span><i class="ti ti-info-circle fs-14 text-orange me-2"></i>Your Product </span> <span class="text-orange fw-semibold" style="color: #E04F16 !important;"> {{$firstLowStockProduct?->product?->name}} is running Low., </span> already below 5 Pcs. <a href="{{route('inventories.create')}}" class=" text-decoration-underline fw-semibold" style="color: #E04F16 !important;">Add Stock</a>
                </div>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                ...
                <!-- Returns -->
                @php
                    $paymentReturn = ($saleReturn ?? 0) + ($purchaseReturn ?? 0);
                @endphp
                <div class="col-xl-3 col-sm-6 col-12 mt-3">
                    <div class="card revenue-widget flex-fill rounded-3" style="border: 1px solid #e6eaed">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2 pb-2 border-bottom">
                                <div>
                                    <h4 class="mb-1">${{ $paymentReturn ?? 0 }}</h4>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <p class="mb-0">
                                    <span class="fs-13 fw-bold text-success">0%</span> vs Last Month
                                </p>
                                <a href="" class="text-decoration-underline fs-13 fw-medium text-dark">View All</a>
                            </div>
                        </div>
        ...
        <div class="container-fluid px-4">
            <div class="row mt-2">
                ...
                <div class="col-md-5 mt-4">
                    <div class="card-shadow rounded p-4 px-3 pb-0 pt-3 w-100 card border-0 h-100">
                                ...
                                <table class="table text-start" id="example4">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($recentTransactions as $sale)
                                            <tr>
                                                <td class="align-middle">#{{ $sale->reference ?? 'N/A' }}</td>
                                                <td class="align-middle">
                                                    <div class="d-flex gap-2 align-items-center ">
                                                        ...
                                                        <div>
                                                            <h6 class="align-middle" style="font-size: 14px">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name="dates"]').on('apply.daterangepicker', function(ev, picker) {
                ...
                // make the url with start end date params in dashboard routes and refresh the page
                var url = "{{ route('dashboard') }}?start=" + start + "&end=" + end;
