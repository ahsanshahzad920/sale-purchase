    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Edit Purchase</h3>
            </div>
            <form class="container-fluid" action="{{ route('purchases.update',$purchase->id) }}" method="POST" id="createPurchaseForm">
                @csrf
                @method('PUT')
                                    ...
                                    <select class="form-control form-select subheading mt-1" required
                                        ...
                                        @foreach ($vendors as $vendor)
                                            <option value="{{ $vendor->id }}"
                                                ...
                                                {{ $vendor->id == $purchase->vendor->id ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select subheading mt-1"
                                        ...
                                        @foreach ($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}" {{$purchase->warehouse_id == $warehouse->id ? 'selected': ''}}>{{ $warehouse->users->name ?? ''}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <table class="table text-center" id="mainTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($purchase->purchaseItems as $product)
                                    @php
                                        $warehouse_product = \App\Models\ProductWarehouse::where('product_id',$product->product->id)->where('warehouse_id',$purchase->warehouse_id)->first();
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <span class="badges bg-darkwarning p-1" data-converted-unit="{{ $product->purchase_units?->id ? $product->purchase_units?->id : '' }}">{{ $quantity ?? '' }}{{ $product->purchase_units?->short_name ? $product->purchase_units?->short_name : '' }}</span>
                                        </td>
                                        <td class="align-middle">
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-center">
                                                <a href="#" class="btn item-edit"
                                                    @php
                                                        $product->product->warehouse_quantity = $warehouse_product->quantity;
                                                    @endphp
                                                    data-product="{{ $product->product ?? ''}}" data-productItem-unit="{{ $product->purchase_units?->id ? $product->purchase_units?->id : false }}"
                    ...
                    <div class="row mt-2 px-3">
                        ...
                        <div class="col-md-4 border rounded-2">
                            <div class="row border-bottom subheading">
                                ...
                                <div class="col-md-6 col-6" id="order_tax_display">${{$purchase->order_tax ?? ''}}</div>
                                {{-- <span> (0.00%)</span> --}}
                            </div>

                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Discount</div>
                                <div class="col-md-6 col-6" id="discount_display">${{$purchase->discount ?? ''}}</div>
                            </div>

                            <div class="row border-bottom">
                                <div class="col-md-6 col-6">Shipping</div>
                                <div class="col-md-6 col-6" id="shipping_display">${{$purchase->shipping ?? ''}}</div>
                            </div>

                            <div class="row disabled-bg">
                                <div class="col-md-6 col-6">Grand Total</div>
                                <div class="col-md-6 col-6" id="grand_total">${{$purchase->grand_total ?? ''}}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-shadow rounded-3 border-0 mt-4 p-2">
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="0%" class="form-control subheading"
                                        id="order_tax" value="{{$purchase->order_tax ?? ''}}"/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="$0.00" class="form-control subheading"
                                        id="discount" value="{{$purchase->discount ?? ''}}"/>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="$0.00" class="form-control subheading"
                                        id="shipping" value="{{$purchase->shipping ?? ''}}"/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" value="{{$purchase->payment_status ?? 'pending'}}" id="payment_status">
                                <input type="hidden" value="{{$purchase->amount_pay ?? '0'}}" id="amount_pay">
                                <input type="hidden" value="{{$purchase->change_return ?? '0'}}" id="change_return">
                                <input type="hidden" value="{{$purchase->amount_received ?? '0'}}" id="amount_received">

                            </div>
                        </div>

                        {{-- <div class="row mt-2" id="purchase-calc" style="display:{{$purchase->payment_status == 'pending' ? 'none' : ''}};">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select subheading"
                                        ...
                                        @foreach ($payments as $payment)
                                            <option value="{{$payment->name}}" {{$purchase->payment_method == $payment->name ? 'selected': ''}}>{{$payment->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @foreach ($bank_accounts as $bank_account)
                                        <option value="{{ $bank_account->id }}" {{ $purchase->bank_account == $bank_account->id ? 'selected' : '' }}>
                                            {{ $bank_account->name }}
                                    @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="amount_received" class="mb-1 fw-bold">Cash Recieved</label>
                                    <input type="text" placeholder="$0.00" class="form-control subheading"
                                        id="amount_received" value="{{$purchase->amount_recieved ?? ''}}"/>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="$0.00" class="form-control subheading"
                                        id="amount_pay" value="{{$purchase->amount_pay ?? ''}}" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="change_return" class="mb-1 fw-bold">Due Amount</label>
                                    <p class="subheading" id="change_return">{{$purchase->amount_due ?? ''}}</p>
                                </div>
                            </div>
                        </div> --}}
                        ...
                        <div class="form-group mt-2">
                            ...
                            <textarea class="form-control subheading" id="notes" placeholder="Add Note" rows="5">{{$purchase->notes}}</textarea>
                        </div>
                    </div>
                </div>
                <!-- Input Fields End -->
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-5 col-12">
                                            ...
                                            {{-- <div class="form-group text-white print-overlay mt-2">
                                                <label for="exampleFormControlSelect1" class="mb-1 fw-bold">Purchases Tax ID</label>
                                                <input type="text" placeholder="Phone No"
                                                    class="form-control subheading text-white" style="background: none"
                                                        ...
                                                        <div class="card-header bg-white border-0 p-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 text-end">
                                                                    <p class="my-1">
                                                                        {{ auth()->user()->contact_no ?? '+123456789' }}</p>
                                                                    <p class="my-1">
                                                                        {{ auth()->user()->email ?? 'company@gmail.com' }}</p>
                                                                    <p class="m-0">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                {{-- <div class="col-md-6" id="unit-secton">
                                    <div class="form-group">
                                        <label for="purchase_unit_item" class="mb-1 fw-bold">Purchase Unit</label>
                                        <select class="form-control form-select subheading"
                                            aria-label="Default select example" id="purchase_unit_item">
...
@section('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // let prodCount = 1;
            let prodCount = {{ count($purchase->purchaseItems) + 1 ?? 1 }};
                ...
                select: function(event, ui) {
                    ...
                    if (!isDuplicate) {
                        ...
                        if(ui.item.product.product_type != 'service'){
                            if(ui.item.product.product_unit != ui.item.product.purchase_unit.id){
            ...
            //     if (this.value == 'paid') {
            //         document.getElementById('purchase-calc').style.display = 'flex';
            //         // grand total value will be set to the amount pay value with disable input and amount_received will be set to grand total value
            ...
            //     } else {
            //         document.getElementById('purchase-calc').style.display = 'none';
            //     }
            // });
            ...
            //         document.getElementById('amount_pay').setAttribute('disabled', true);
            //         document.getElementById('amount_received').value = grandTotal;
            //         document.getElementById('amount_received').setAttribute('disabled', true);
            ...
            //         // document.getElementById('amount_pay').value = 0;
            //         // var amountPayInput = document.getElementById('amount_pay');
            //         if (document.getElementById('amount_received').disabled) {
            ...
            $('#mainTable tbody tr').each(function() {
                ...
                if (rowProductId === updatedProduct.id) {
                    ...
                    $(this).find('td:nth-child(5)').html(
                        `<span class="badges bg-darkwarning p-1" data-converted-unit="${updatedProduct.purchase_unit?.id ? updatedProduct.purchase_unit.id : ''}">${updatedStock ?? product_details.warehouse_quantity}${updatedProduct.purchase_unit?.short_name ? updatedProduct.purchase_unit.short_name : ''}</span>`
                        );
                    ...
                    $(this).find('td:nth-child(9)').find('a').attr('data-productItem-unit', JSON.stringify(updatedProduct.purchase_unit?.id));
        ...
        $(document).ready(function() {
            $('#createPurchaseForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...formData,
                        _method: 'PUT' // Add this line to spoof a PUT request
                    },
        ...
        $(document).ready(function() {
            ...
            function AddDetailsInModal() {
                ...
                var am_recieved = document.getElementById('amount_received').value;
                ...
                document.getElementById('amount_received_modal').innerHTML = am_recieved;
                ...
                var selectedOption = vendors.options[vendors.selectedIndex];
