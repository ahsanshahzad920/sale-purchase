    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Create Sale Return</h3>
            </div>
                            ...
                            <tbody>
                                @foreach ($sale->productItems as $product)
                                    <tr>
                                        ...
                                        <td class="align-middle"> <span class="badges bg-darkwarning p-1">{{ $product->quantity ?? '' }} {{ $product->sale_units?->short_name ? $product->sale_units->short_name : ''}}</span></td>
