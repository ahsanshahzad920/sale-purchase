    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4 mb-5">
            <div class="border-bottom">
                <h3 class="all-adjustment text-center pb-2 mb-0">Manual Sale Return</h3>
            </div>
            <form class="container-fluid" action="{{ route('manual-sale-return.store') }}" method="POST" id="createSaleForm">
                ...
                <!-- Input Fields End -->
                <button class="btn save-btn text-white mt-3" type="submit" id="create-sale-return">
                    <div class="spinner-border text-light spinner-border-sm ms-2 me-2" role="status" id="btn-spinner"
                        style="display: none">
                    </div>
            ...
            $('#createSaleForm').on('submit', function(e) {
                ...
                $('#mainTable tbody tr').each(function() {
                    let item = {
                        ...
                        return_unit: $(this).find('td:nth-child(5) span').data(
                            'converted-unit'),
                ...
                $.ajax({
                    url: '{{ route('manual-sale-return.store') }}',
                    type: 'POST',
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        toastr.success('Manually Sale Return created successfully!');
