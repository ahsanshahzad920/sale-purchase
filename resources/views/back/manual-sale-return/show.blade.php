                    ...
                    <div id="invoice">
                        <div class="row mb-4">
                            <div class="col-md-4 col-6 mt-2">
                                ...
                                <p class="m-0">{{ $sale_return->customer->user->name ?? '' }}</p>
                                <p class="m-0">{{ $sale_return->customer->user->email ?? '' }}</p>
                                <p class="m-0">{{ $sale_return->customer->user->contact_no ?? '' }}</p>
                                <p class="m-0">{{ $sale_return->customer->user->address ?? '' }}</p>
                            </div>
                            <div class="col-md-4 col-6 mt-2">
                                ...
                                <p class="m-0">{{ $user->email ?? 'N/A' }}</p>
                                <p class="m-0">{{ $user->contact_no ?? 'N/A' }}</p>
                            ...
                            <div class="col-md-4 col-6 mt-2">
                                ...
                                <p class="m-0">Payment Status : <span
                                        class="badges green-border text-center">{{ $sale_return->payment_status ?? '' }}</span>
                                </p>
                                <p class="m-0">Warehouse : {{ $sale_return->warehouse->users->name ?? '' }}</p>
                                <p class="m-0">Status : <span
                                        class="badges blue-border text-center">{{ $sale_return->status ?? '' }}</span></p>
                            </div>
                        </div>
