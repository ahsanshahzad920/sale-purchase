                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                                ...
                                <a href="{{route('super.coupons.create')}}" class="btn create-btn rounded-3 mt-2">
                                    Create Coupons <i class="bi bi-plus-lg"></i>
                                </a>
                                    ...
                                    <td class="pt-2">
                                        <div class="" style="overflow: visible">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class=" dropdown-item" href="{{route('super.coupons.edit', $coupon->id)}}"
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <form action="{{route('super.coupons.destroy', $coupon->id)}}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <img src="{{ asset('back/assets/dasheets/img/menu.svg') }}"
