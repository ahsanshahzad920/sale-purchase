            ...
            <div class="card card-shadow border-0 mt-3 rounded-3 p-2">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table" id="example">
                        <thead class="fw-bold">
                            <tr>
                                <th class="text-secondary fw-normal">Transaction#</th>
                                <th class="text-secondary fw-normal">Date</th>
                                <th class="text-secondary fw-normal">Customer Name</th>
                                <th class="text-secondary fw-normal">Payment Method</th>
                                <th class="text-secondary fw-normal">Amount</th>
                                <th class="text-secondary fw-normal">Payment Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{ $payment->subscription->tenant?->user->name ?? '' }}</td>
