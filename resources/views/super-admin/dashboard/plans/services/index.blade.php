                ...
                <div class="card-header bg-white border-0 rounded-3">
                    <div class="row my-3">
                        ...
                        <div class="col-md-8 col-12 text-end">
                                ...
                                <a href="{{route('super.services.create')}}" class="btn create-btn rounded-3 mt-2">
                        ...
                        <tbody>
                            @foreach ($services as $item)
                                <tr>
                                    <td class="pt-3">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{ $item->id }}" />
                                    ...
                                    <td class="align-middle">{{ $item->plan->title ?? '' }} | {{ $item->plan->type ?? '' }}</td>
                                    ...
                                    <td class="pt-2">
                                        <div class="" style="overflow: visible">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class=" dropdown-item" href="{{route('super.services.edit', $item->id)}}"
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <form action="{{route('super.services.destroy', $item->id)}}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <img src="{{ asset('back/assets/dasheets/img/menu.svg') }}"
