                        ...
                        <tbody>
                            @foreach ($plans as $plan)
                                <tr>
                                    <td class="pt-3">
                                        <label for="select-checkbox" class="checkbox">
                                            <input class="checkbox__input select-checkbox deleteRow" type="checkbox"
                                                id="select-checkbox" data-id="{{ $plan->id }}" />
                                    ...
                                    <td class="align-middle">{{ $plan->title ?? '' }}</td>
                                    <td class="align-middle">{{ $plan->sub_title ?? '' }}</td>
                                    <td class="align-middle">{{ $plan->price ?? '' }}</td>
                                    <td class="align-middle">{{ $plan->type ?? '' }}</td>
                                    ...
                                    <td class="pt-2">
                                        <div class="" style="overflow: visible">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class=" dropdown-item" href="{{route('super.plans.edit', $plan->id)}}"
