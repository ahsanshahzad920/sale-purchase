            ...
            <div class="framebox">
                <div class="owl-carousel">
                    ...
                    @foreach ($new_products as $product)
                        <a href="{{ route('user.product.index', ['code' => $product->category->code, 'sku' => $product->sku, 'subdomain' => request()->route('subdomain')]) }}"
                            class="item ">
                            ...
                            <div class="tab-content card-shadow" id="pills-tabContent">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        @foreach ($top_selling_products as $product)
                                            <div class="selling-product col-lg-4 col-md-4 p-2 border">
                                                <a
                                                    href="{{ route('user.product.index', ['code' => $product->product->category->code, 'sku' => $product->product->sku,'subdomain' => request()->route('subdomain')]) }}">
                                                    <div class="card tab-card border-0 rounded-0">
                                                        ...
                                                        <div class="card-footer border-0  bg-transparent text-center">
                                                            ...
                                                            <h3 class="product-name">
                                                                <a
                                                                    href="{{ route('user.product.index', ['code' => $product->product->category->code, 'sku' => $product->product->sku,'subdomain' => request()->route('subdomain')]) }}">{{ $product->product->name }}</a>
                                                            </h3>
                                ...
                                <div class="tab-pane fade" id="pills-newproducts" role="tabpanel"
                                    ...
                                    <div class="d-flex flex-wrap">
                                        @foreach ($new_products as $product)
                                            <a
                                                href="{{ route('user.product.index', ['code' => $product->category->code, 'sku' => $product->sku,'subdomain' => request()->route('subdomain')]) }}">
                                                <div class="selling-product col-lg-3 col-md-4 p-2 border">
                                                    <div class="card tab-card border-0 rounded-0">
                                                        ...
                                                        <div class="card-footer border-0  bg-transparent text-center">
                                                            ...
                                                            <h3 class="product-name">
                                                                <a
                                                                    href="{{ route('user.product.index', ['code' => $product->category->code, 'sku' => $product->sku,'subdomain' => request()->route('subdomain')]) }}">{{ $product->name }}</a>
                                                            </h3>
                                                            <div class="text-warning">
